...
export const getToken = (req) => {
  // req contains all request info like header, type of request (GET), cookies etc
  // req contains Key who's data type is Symbol & its corresponding value is whole req object.
  // So, we have to access that key. (Its not similar to other keys in object)
